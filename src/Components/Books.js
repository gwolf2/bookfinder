...
import {Accordion, Col, Grid, ListGroup, ListGroupItem, Panel, Row, Button} from "react-bootstrap";
              ...
              <Row>
                ...
                <Col xs={8} md={8} lg={8}>
                  <ListGroup>
                    ...
                    <ListGroupItem><strong>Year Published: </strong>{publishedDate}</ListGroupItem>
